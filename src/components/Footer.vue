    ...
    <footer class="footer">
        <div class="container">
            <div class="content has-text-centered">
                <p>
                    <strong>Site-tracking</strong> desenvolvido por <a href="https://github.com/gabrielboliveira">Gabriel Oliveira</a>. <br>
                    O site não é oficial e utiliza informações de APIs abertas do Correios.<br>
